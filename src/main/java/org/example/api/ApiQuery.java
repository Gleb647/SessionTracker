...
import org.example.util.TeeInputStream;
...
public abstract class ApiQuery<EC extends ApiQuery.ErrorCode> {
     ...
     */
    public URLConnection sendPostRequest(final ApiCredentials credentials, final JsonObjectBuilder requestContent) throws ApiException.ConnectionFailure {
     ...
     */
    public static int decodeJsonResult(final URLConnection connection, final String key) throws ApiException {
